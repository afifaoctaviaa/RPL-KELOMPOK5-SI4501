...
<body>
    <span class="d-block p-5">
        ...
        <p class="fs-6  ms-2" style="color:#4D4536;">Donasi Anda dapat membantu mengubah kehidupan anak-<br>anak,
            keluarga, dan komunitas yang kurang mampu.</p>
        <div class="p-2 g-col-6 ms-4">
            <a type="button" class="btn text-light" style="background-color:#AA8B56;" href="/tentangkami"> Tentang
                Kami</a>
            <a type="button" class="btn text-light" style="background-color:#4E6C50;" href="/registrasi">Daftar
                Sekarang</a>
        </div>
    </span>
    <!-- Code Mitra Kami -->
    <div class="container text-start mt-3">
        <div class="row g-1">
            ...
            <div class="col-9">
                <div class="p-1 fs-6 mt-2">Lorem Ipsum Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus
                    ac aliquet lorem.</div>
            </div>
        </div>
    </div>
    ...
    <div class="container text-center ms-6">
        <div class="row justify-content-start">
            ...
            <div class="col-sm-3">
                    <a href="{{ route('mitra', ['id' => $mitra->id]) }}">
                        <div class="card" >
                            <img src="{{ asset('storage/foto_mitra/' . $mitra->foto_mitra) }}" class="card-img-top"
                                alt="...">
                            <div class="card-body">
                                <p class="card-text">{{$mitra->nama_organisasi}}</p>
                            </div>
                        </div>
                    </a>
                </div>
