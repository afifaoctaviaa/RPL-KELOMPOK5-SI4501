        ...
        <div class="col-md-3">
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative"
                ...
                <div class="col p-4 d-flex flex-column position-static">
                    ...
                    <p class="mb-auto mt-2"></p>
                    <a href="{{ route('admin.reviews.index') }}" class="icon-link gap-1 icon-link-hover stretched-link">
                        Check Sekarang
                        <svg class="bi">
                            <use xlink:href="#chevron-right" />
                        </svg>
                            ...
                            <ul class="list-unstyled">
                                ...
                                @foreach ($donasi as $d)
                                    <li>
                                        <a class="d-flex flex-column flex-lg-row gap-3 align-items-start align-items-lg-center py-3 link-body-emphasis text-decoration-none border-top text-light"
                                            href="#">
                                            <img src="{{ asset('storage/barang').'/'.$d->foto_barang }}" alt="foto-barang" width="200">
                                            <div class="col-lg-8">
                                                <h6 class="mb-0">{{ $d->nama_barang }}</h6>
                                                <small class="text-light">{{ Carbon\Carbon::parse($d->created_at)->diffForHumans() }}</small>
                                            </div>
                                        </a>
                                    </li>
                                @endforeach
