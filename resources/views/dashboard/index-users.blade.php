...
@section('tittle', 'BagiBarang | Dashboard User')
            ...
            <div class="col-md-6">
                ...
                <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative text-light"
                    ...
                    <div class="col p-4 d-flex flex-column position-static">
                        ...
                        <p class="card-text mb-auto mt-2">Barang-barang yang Anda donasikan akan kirimkan kepada
                            Panti-panti yang Membutuhkan.</p>
                                ...
                                <li>
                                    <a class="d-flex flex-column flex-lg-row gap-3 align-items-start align-items-lg-center py-3 link-body-emphasis text-decoration-none border-top"
                                        ...
                                        <div class="col-lg-8">
                                            ...
                                            <small class="text-body-secondary">{{ Carbon\Carbon::parse($notification->created_at)->diffForHumans() }}</small>
                                        </div>
                                    </a>
                                </li>
                            @endforeach
